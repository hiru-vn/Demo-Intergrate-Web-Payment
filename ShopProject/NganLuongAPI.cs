...
namespace ShopProject
{
    ...
    {
        public static string merchant_id = "36680";
        public static string merchant_password = "matkhauketnoi";
        public static string receiver_email = "demo@nganluong.vn";
        public static string cur_code = "vnd";
